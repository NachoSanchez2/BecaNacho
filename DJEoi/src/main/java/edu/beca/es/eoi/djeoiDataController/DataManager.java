package edu.beca.es.eoi.djeoiDataController;
...
public class DataManager {
	...
	public void readProperties() throws IOException {
		...
		logger.debug("Ruta del archivo: " + "src/main/resources/djeoi.properties");

		FileInputStream input = new FileInputStream(new File("src/main/resources/djeoi.properties"));
