package edu.beca.es.eoi.aleoixaDataManager;
...
public class DataManager {
	...
	public void propertiesAplicate() {
		...
		try {
			...
			logger.debug("Could not found file .properties: " + e.getStackTrace());
		}
	...
	public void readProperties() throws IOException {
		...
		logger.debug("Ruta del archivo: " + "src/main/resources/aleoixa.properties");

		FileInputStream input = new FileInputStream(new File("src/main/resources/aleoixa.properties"));
