...
public class DataManager {
	...
	public void readProperties() throws IOException {
		...
		logger.debug("Ruta del archivo: " + "src/main/resources/univeoirsidad.properties");

		FileInputStream input = new FileInputStream(new File("src/main/resources/univeoirsidad.properties"));
